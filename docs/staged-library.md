...
38 → 62 titles in a single session, two graphics cards were swapped mid-session,
...
| `192.168.1.124` | NSC-C543575F526 | 2004 MHz | 255 MB | AMIGAMERLIN 3.1-R11 For Voodoo 5 6 | Windows XP |
...
| title | `.123` | `.124` | `.133` | `.143` | `.145` | `.171` | `.184` | `.185` | `.186` | `.191` | `.240` | `.243` | `.246` | `.249` | verified |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
...
**62 titles × 14 machines = 868 cells — 271 verified, 500 untested.**

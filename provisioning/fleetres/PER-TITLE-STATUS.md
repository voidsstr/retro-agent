...
| **Turok2** | **incapable (1024x768 max)** | one **boolean per mode** in `Data\config.ned`, largest 4:3 entry that fits | the list is compiled into `Video_D3D.dll`: 320x240 / 512x384 / 640x480 / 800x600 / 1024x768 / 1280x1024. No 1080p entry, no custom mode. 1280x1024 is explicitly written back to 0 — it is 5:4 |

...
**State (audited 2026-09-23): a skeleton whose DDK driver cannot compile, and
would not work if it did.** The DDK driver has never been built or loaded. The
only build on record is a host cross-compile and test of the non-DDK escape
dispatcher (commit `169df87`, 2026-07-16), and that test was never committed. The fuller

...
GAMES = {
    ...
    2010: [
        ("Mass Effect 2", "acclaimed sci-fi RPG"),
        ("StarCraft II: Wings of Liberty", "RTS esports landmark"),
        ("Red Dead Redemption", "open-world western epic"),
        ("Sid Meier's Civilization V", "definitive 4X strategy"),
        ("Fallout: New Vegas", "open-world RPG milestone"),
        ("BioShock 2", "atmospheric FPS sequel"),
        ("Battlefield: Bad Company 2", "destructible warfare"),
        ("Amnesia: The Dark Descent", "survival-horror landmark"),
    ],
    2011: [
...
MACHINES = [
    ...
    {
        "host": "192.168.1.246", "hostname": "ADMIN-PC",
        "title": "Sandy Bridge Workstation - Windows 7",
        "width": 1920, "height": 1080,
        "accent": [90, 200, 130], "accent2": [90, 170, 255],
        "cpu_year": 2011, "gpu_year": 2010,
        "cpu_label": "Intel Core i5-2400 - launched 2011",
        "gpu_label": "AMD Radeon HD 5450 - launched 2010",
        "specs": [
            ["CPU", "Core i5-2400 @ 3.10GHz"],
